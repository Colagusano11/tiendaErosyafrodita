    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.POST, "/pedidos/pago/revolut", "/api/pedidos/pago/revolut", "/pedidos/pago/paypal", "/api/pedidos/pago/paypal", "/pedidos/pago/paypal/capture", "/api/pedidos/pago/paypal/capture").permitAll()
                .requestMatchers(HttpMethod.POST, "/pedidos/pago/confirmar", "/api/pedidos/pago/confirmar").permitAll()
                // Webhook de pago (sin JWT)
                .requestMatchers(HttpMethod.POST, "/pagos/revolut/webhook", "/api/pagos/revolut/webhook", "/api/pagos/webhook/paypal").permitAll()
