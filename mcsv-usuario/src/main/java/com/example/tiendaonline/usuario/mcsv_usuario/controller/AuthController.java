...
public class AuthController {
  ...
  public AuthController(UsuarioService uService,PasswordResetService rService){
  ...
  public ResponseEntity<?> resendCode(@RequestBody Map<String, String> req) {
    ...
    String email = principal.getAttribute("email");  // debería existir con scope email
