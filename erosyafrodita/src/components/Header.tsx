...
const Header: React.FC = () => {
  ...
  return (
    <header className="sticky top-0 z-50 w-full bg-charcoal border-b border-white/10 backdrop-blur-md bg-charcoal/95">
      ...
      {/* Mobile Drawer */}
      {isMobileMenuOpen && (
        <div className="fixed inset-0 z-[100] bg-black/90 backdrop-blur-md lg:hidden animate-fade-in">
          <div className="absolute left-0 top-0 h-full w-[300px] bg-black p-8 shadow-[10px_0_40px_rgba(0,0,0,0.8)] animate-slide-right border-r border-white/10">
