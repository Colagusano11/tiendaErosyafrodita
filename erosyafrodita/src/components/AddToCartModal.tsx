            ...
            {isModalOpen && lastAddedProduct && (
                <div className="fixed inset-0 z-[99999] flex items-center justify-center p-4">
                    ...
                    <motion.div 
                        ...
                        className="relative bg-charcoal-surface w-full max-w-sm rounded-[2.5rem] border border-charcoal/10 p-8 shadow-[0_40px_80px_-15px_rgba(0,0,0,0.2)] overflow-hidden"
                    >
                        {/* Glow effect */}
                        ...
                        <div className="relative z-10 flex flex-col items-center text-center">
                            ...
                            <h2 className="text-2xl font-black text-charcoal mb-2 tracking-tighter uppercase">¡Añadido con éxito!</h2>
                            <p className="text-charcoal/50 text-[13px] mb-8 leading-relaxed font-light">Este tesoro ha sido incluido en tu bolsa de compra.</p>

                            <div className="w-full bg-charcoal/5 rounded-3xl p-4 flex items-center gap-4 mb-8 border border-charcoal/5">
                                ...
                                <div className="text-left overflow-hidden">
                                    <h3 className="text-charcoal font-bold text-xs truncate uppercase tracking-widest">{lastAddedProduct.nombre}</h3>
                            ...
                            <div className="flex flex-col w-full gap-3">
                                ...
                                <button 
                                    onClick={closeModal}
                                    className="w-full h-12 text-charcoal/40 hover:text-charcoal font-bold text-[10px] uppercase tracking-widest transition-all active:scale-95"
                                >
                                    Seguir Explorando
                                </button>
                            </div>
