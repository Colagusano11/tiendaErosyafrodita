...
const Wishlist: React.FC = () => {
  ...
  return (
    <div className="bg-background-dark text-charcoal min-h-screen flex flex-col font-display selection:bg-primary/30">
      <Header />

      <main className="flex-grow w-full max-w-[1440px] mx-auto px-4 lg:px-10 py-8 md:py-20">
        {/* Cabecera de la sección */}
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-8 md:mb-12 gap-6 border-b border-charcoal/10 pb-8 md:pb-10">
          <div className="animate-in fade-in slide-in-from-left duration-1000">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-black tracking-tighter text-charcoal uppercase">
              Mis <span className="text-primary italic">Deseos</span>
            </h1>
            <p className="mt-4 text-charcoal/60 max-w-lg text-sm sm:text-base md:text-lg font-light leading-relaxed">
              Conserva tus fragancias favoritas y hazte con ellas cuando el momento sea perfecto. Tu selección exclusiva de AGE Parfums.
            </p>
          </div>
        ...
        {wishlist.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-20 text-center animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <p className="text-charcoal/60 mb-10 max-w-sm font-light text-sm sm:text-base">
              Parece que aún no has encontrado ese aroma especial. Explora nuestro catálogo y deja que tu fragancia te encuentre.
            </p>
            <Link
              to="/catalog"
              className="px-10 py-5 bg-primary text-charcoal rounded-2xl font-black text-xs tracking-widest uppercase hover:bg-yellow-400 hover:shadow-[0_0_30px_rgba(242,185,13,0.3)] transition-all transform active:scale-95"
            >
              Explorar Catálogo
            </Link>
          </div>
