    ...
    <div className="bg-background-dark font-display text-charcoal min-h-screen flex flex-col">
      ...
      <main className="flex-1 max-w-3xl mx-auto w-full px-4 py-16">
        ...
        <div className="space-y-4">
          <details className="bg-surface-dark text-white border border-border-dark rounded-xl p-4 cursor-pointer group">
          ...
          <details className="bg-surface-dark text-white border border-border-dark rounded-xl p-4 cursor-pointer group">
            ...
            <p className="mt-4 text-gray-400">Absolutamente. En AGE Parfums solo trabajamos directamente con las casas de moda y distribuidores oficiales. Garantizamos la autenticidad de cada frasco.</p>
          </details>
        </div>
      </main>
      <Footer />
