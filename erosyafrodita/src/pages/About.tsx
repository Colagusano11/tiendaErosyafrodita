...
const About: React.FC = () => {
  return (
    <div className="bg-background-dark font-display text-charcoal min-h-screen flex flex-col">
      <Header />
      <div className="relative min-h-[50vh] flex items-center justify-center overflow-hidden text-white">
        <div 
      ...
      <div className="max-w-4xl mx-auto px-6 py-20 text-center text-lg text-charcoal/70 leading-relaxed">
        <p className="mb-6">En AGE Parfums, creemos que el perfume no es solo un accesorio invisible, sino una extensión poderosa de tu personalidad. Es un arte líquido que evoca recuerdos, despierta emociones y narra historias sin palabras.</p>
