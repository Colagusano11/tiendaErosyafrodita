  ...
  return (
    <div className="bg-background-dark font-display text-charcoal min-h-screen flex flex-col">
      ...
      <main className="flex-grow w-full max-w-4xl mx-auto px-4 md:px-10 py-12">
        ...
        {/* Datos de la empresa */}
        <div className="bg-charcoal-surface border border-charcoal/10 rounded-2xl p-6 md:p-8 mb-10">
          ...
          <ul className="flex flex-col gap-3 text-sm text-charcoal/70">
            <li className="flex gap-3">
              ...
              <span><span className="text-charcoal font-semibold">Denominación Social:</span> CELEGOR SL</span>
            </li>
            <li className="flex gap-3">
              <span className="text-primary shrink-0">·</span>
            ...
            <li className="flex gap-3">
              <span className="text-primary shrink-0">·</span>
              <span><span className="text-charcoal font-semibold">Domicilio Social:</span> AVDA. SANTA EUGENIA N. 29 – 28031 MADRID</span>
            </li>
            <li className="flex gap-3">
              <span className="text-primary shrink-0">·</span>
              <span>
            ...
            <li className="flex gap-3">
              <span className="text-primary shrink-0">·</span>
              <span>
                <span className="text-charcoal font-semibold">Teléfono de Contacto:</span>{" "}
        ...
        <div className="flex flex-col gap-8">
          ...
          <section>
            <h2 className="text-charcoal text-lg font-black uppercase tracking-wide mb-3 flex items-center gap-3">
