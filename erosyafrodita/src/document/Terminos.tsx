        ...
        <div className="flex flex-col gap-10">
          ...
          <section>
            ...
            <p className="text-charcoal/60 text-sm leading-relaxed mb-3">
              El presente sitio web es propiedad de <span className="text-charcoal font-semibold">CELEGOR, S.L.</span> (en adelante, "la Empresa"), con NIF/CIF <span className="text-charcoal">ESB81267163</span> y domicilio en AVDA. SANTA EUGENIA N. 29 – 28031 MADRID.
            </p>
          ...
          <section>
            ...
            <div className="flex flex-col gap-3">
              {[
                ...
                <div key={item.titulo} className="flex gap-3 text-sm text-charcoal/60">
                  <span className="text-primary shrink-0 mt-0.5">·</span>
                  <span><span className="text-charcoal font-semibold">{item.titulo}:</span> {item.texto}</span>
                </div>
              ))}
            </div>
          </section>
          ...
          <section>
            ...
            <div className="bg-charcoal-surface border border-charcoal/10 rounded-2xl p-6">
              ...
              <ul className="flex flex-col gap-3 text-sm text-charcoal/60">
                {[
          ...
          <section>
            ...
            <p className="text-charcoal/60 text-sm leading-relaxed mb-5">
              De acuerdo con la normativa vigente en materia de consumidores y usuarios, el cliente dispone de un plazo de <span className="text-charcoal font-semibold">14 días naturales</span> desde la recepción del pedido para ejercer su derecho de desistimiento sin necesidad de justificación.
            </p>
            <div className="flex flex-col gap-3">
              {[
                {
          ...
          {/* Contacto */}
          <div className="bg-charcoal-surface border border-charcoal/10 rounded-2xl p-6 flex flex-col sm:flex-row items-start sm:items-center gap-4">
