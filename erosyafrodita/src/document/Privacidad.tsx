    ...
    <div className="bg-background-dark font-display text-charcoal min-h-screen flex flex-col">
      ...
      <main className="flex-grow w-full max-w-4xl mx-auto px-4 md:px-10 py-12">
        ...
        <div className="mb-10 border-b border-charcoal/10 pb-8">
          <h1 className="text-4xl md:text-5xl font-black tracking-tight text-charcoal uppercase">
        ...
        <div className="flex flex-col gap-10">
          ...
          {/* 1. Responsable */}
          <section>
            <h2 className="text-charcoal text-lg font-black uppercase tracking-wide mb-4 flex items-center gap-3">
            ...
            <div className="bg-charcoal-surface border border-charcoal/10 rounded-2xl p-6">
              <ul className="flex flex-col gap-3 text-sm text-charcoal/70">
                <li className="flex gap-3">
                  ...
                  <span><span className="text-charcoal font-semibold">Identidad:</span> CELEGOR, S.L.</span>
                </li>
                <li className="flex gap-3">
                  <span className="text-primary shrink-0">·</span>
                  <span><span className="text-charcoal font-semibold">NIF/CIF:</span> ESB81267163</span>
                </li>
                <li className="flex gap-3">
                  <span className="text-primary shrink-0">·</span>
                  <span><span className="text-charcoal font-semibold">Dirección Postal:</span> AVDA. SANTA EUGENIA N. 29 – 28031 MADRID</span>
                </li>
                <li className="flex gap-3">
                  <span className="text-primary shrink-0">·</span>
                  <span>
          ...
          <section>
            ...
            <div className="flex flex-col gap-4">
              {[
                ...
                <div key={item.titulo} className="bg-charcoal-surface border border-charcoal/10 rounded-xl p-5">
                  ...
                  <div className="flex flex-col gap-2 text-sm text-charcoal/60">
                    <p><span className="text-charcoal font-semibold">Datos:</span> {item.datos}</p>
                    <p><span className="text-charcoal font-semibold">Finalidad:</span> {item.finalidad}</p>
                    <p><span className="text-charcoal font-semibold">Base Legal:</span> {item.base}</p>
                  </div>
                </div>
              ))}
            </div>
          ...
          <section>
            ...
            <ul className="flex flex-col gap-3">
              {[
                ...
                <li key={item.label} className="flex gap-3 text-sm text-charcoal/60">
                  <span className="text-primary shrink-0 mt-0.5">·</span>
                  <span><span className="text-charcoal font-semibold">{item.label}:</span> {item.texto}</span>
                </li>
              ))}
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="flex flex-col gap-3">
              <li className="flex gap-3 text-sm text-charcoal/60">
                <span className="text-primary shrink-0 mt-0.5">·</span>
                <span>
              ...
              <li className="flex gap-3 text-sm text-charcoal/60">
                <span className="text-primary shrink-0 mt-0.5">·</span>
                <span>
                  <span className="text-charcoal font-semibold">Obligación legal:</span> Cuando estemos legalmente obligados a hacerlo (por ejemplo, a autoridades fiscales o judiciales).
                </span>
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="flex flex-col gap-2 mb-6">
              {[
                ...
                <li key={derecho} className="flex gap-3 text-sm text-charcoal/60">
                  <span className="text-primary shrink-0 mt-0.5">·</span>
                  <span>{derecho}</span>
                </li>
              ))}
            ...
            <div className="bg-charcoal-surface border border-charcoal/10 rounded-xl p-5 text-sm text-charcoal/60 leading-relaxed">
              ...
              <p className="mt-3">
                ...
                <span className="text-charcoal font-semibold">Agencia Española de Protección de Datos (AEPD)</span> si consideras que el tratamiento de tus datos no cumple con la normativa.
              </p>
            </div>
          </section>
